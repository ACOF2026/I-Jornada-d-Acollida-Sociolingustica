...
`,
    ...
    comG_Bio: "<b>Muniba Munir Siraj</b>. Es graduada en Filosofía con un Minor en Estudios de Género. Ha colaborado en diversos proyectos educativos, como AFEX de Casa Àsia. Nacida en Pakistán y criada en Barcelona.<br><br> <b>Iqra Sharif</b>. Barcelonesa de origen pakistaní, habla cinco idiomas y combina su trabajo como higienista dental y gestora de redes sociales con los estudios de Farmacia en la UB. Hace tres años que es dinamizadora del proyecto AFEX de Casa Àsia, donde trabaja para romper barreras lingüísticas y promover la inclusión de la comunidad asiática.",
    imgComuniG: "<img src='img/G. Muniba Munur bé.png' class='w-40 h-40 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Muniba Munir Siraj'><img src='img/G. Iqra.jpg' class='w-40 h-40 rounded-2xl object-cover mb-4 shadow-lg border-2 border-white' alt='Iqra Sharif'> ",
